...
/**
 * FooterMinimal — the dark footer base WITHOUT the overlapping BookingForm banner.
 * Used on pages like /contact that already have their own booking form section.
 */
export const FooterMinimal: React.FC = () => {
  ...
  return (
    <footer className="w-full bg-[#1C1A17] text-white relative">
      ...
      <div className="relative z-30 mx-auto max-w-[1440px] px-[24px] sm:px-[40px] pt-[80px] pb-[60px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            <h4 className="font-serif font-medium text-[18px] text-white">Explore</h4>
            <ul className="flex flex-col gap-2.5 font-sans text-[14px] text-white/70">
              <li><Link href="/about" className="hover:text-white transition-colors">About us</Link></li>
              <li><Link href="/about#pillars" className="hover:text-white transition-colors">Our Philosophy</Link></li>
              <li><Link href="/results" className="hover:text-white transition-colors">Results Gallery</Link></li>
              <li><Link href="/about#team" className="hover:text-white transition-colors">Medical Team</Link></li>
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            <h4 className="font-serif font-medium text-[18px] text-white">Services</h4>
            <ul className="flex flex-col gap-2.5 font-sans text-[14px] text-white/70">
              <li><Link href="/treatments/injectables" className="hover:text-white transition-colors">Injectables</Link></li>
              <li><Link href="/treatments/hydration" className="hover:text-white transition-colors">Skin Rehab</Link></li>
              <li><Link href="/treatments/laser" className="hover:text-white transition-colors">Laser Therapy</Link></li>
              <li><Link href="/treatments/collagen" className="hover:text-white transition-colors">Collagen</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-2 flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              <h4 className="font-serif font-medium text-[18px] text-white">Address</h4>
            ...
            <div className="flex flex-col gap-1.5 pt-2">
              <h4 className="font-serif font-medium text-[18px] text-white">Email</h4>
              <a
          ...
          <div className="lg:col-span-3 flex flex-col gap-4">
            <h4 className="font-serif font-medium text-[18px] text-white">Subscribe newsletter</h4>
            <p className="font-sans text-[13px] leading-[1.5] text-white/70">
              Stay updated with the latest news and offers!
            </p>
            {subscribed ? (
              <p className="font-sans text-[13px] text-[#C9A876]">✓ Subscribed! Thank you.</p>
            ) : (
